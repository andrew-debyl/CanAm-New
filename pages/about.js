              ...
              <div className="about-one__right">
                ...
                <div className="about-one__right-inner">
                  <p className="about-one__right-text">
                    CanAm Imaging is committed to exceptional customer service,
                    offering more than just equipment with flexible financing,
                    guarantees, and comprehensive after-sales support. With
                    facilities in Rochester (NY) and Richmond Hill (ON) we serve
                    both North American and international clients of Canon,
                    Kodak, Konica Minolta, Ricoh, and Xerox. Our 65 years of
                    experience, engineering expertise, and skilled
                    reconditioning team ensure top-quality pre-owned equipment
                    and parts for high and mid-volume print and copy businesses.
                    We provide solutions for reselling, individual units, or
                    fleet installations, aiming to boost efficiency and
                    profitability. Selected reconditioned Xerox equipment
